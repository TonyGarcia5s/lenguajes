...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <form method="POST" name="entity_update">
...
<!-- /.content -->
  ...
  <script>
    ...
    // Define los datos para tu gráfico (esto es solo un ejemplo)
    var data = {
      labels: ['2014', '2015', '2016', '2017',],
      datasets: [{
        label: 'Cantidad de Alumnos Matriculados',
        data: [150, 120, 85, 50, 2,],
        backgroundColor: [
          'rgba(255, 99, 132, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
    ...
    // Configura las opciones para tu gráfico (puedes personalizar según tus necesidades)
    var options = {
      scales: {
        yAxes: [{
          ticks: {
